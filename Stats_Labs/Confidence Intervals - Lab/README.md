...
for x in range(100):
    sample = np.random.choice(population_ages, size=500) #Take 100 samples of 500 people
...
pd.DataFrame(point_estimates).plot(kind='kde',figsize=(9,9))
```
...
for sample in range(25):
    ...
    pop_std_dev=population_ages.std()
